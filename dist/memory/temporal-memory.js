export class TemporalMemory {
    ...
    confidenceThreshold;
    messageCount = 0;
    constructor(decayRate = 0.95, maxHistoryLength = 100, confidenceThreshold = 0.3) {
    ...
    updateStateConfidence(stateId, newConfidence) {
        ...
        let updated = false;
        const now = Date.now();
        const updateInArray = (states, type) => {
